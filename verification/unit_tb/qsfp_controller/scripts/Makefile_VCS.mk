...
ifndef TEST_DIR
	...
	cd $(VERDIR)/unit_tb/qsfp_controller/sim && mkdir $(TEST_DIR) && cd $(TEST_DIR) &&  cp $(WORKDIR)/sim/scripts/qip_gen/ipss/qsfp/ip/qsfp_ctrl/sim/../../qsfp_ctrl_onchip_memory2_0/sim//../altera_avalon_onchip_memory2_1937/sim/*.hex . &&  ../simv $(CFG_SW) $(SIMV_OPT) $(SIMV_OPT_EXTRA) ; perl $(WORKDIR)/../env_not_shipped/tools/bin/postsim.pl
