...
def build_sim_env(platform, coverage, simulator, package):
    ...
    if (coverage == 'ral_cov'):
        if (simulator == 'vcs'):
            if (package == 'rx_pkg'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} COV=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} DEBUG=1 COV=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} COV=1"
                build_command_line  = f"gmake -f {makefile} {build} DEBUG=1 COV=1"
        else:
            if (package == 'rx_pkg'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} COV=1 MSIM=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} COV=1 MSIM=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} COV=1 MSIM=1"
                build_command_line  = f"gmake -f {makefile} {build} COV=1 MSIM=1"
    elif (coverage == 'fun_cov'):
        if (simulator == 'vcs'):
            if (package == 'rx_pkg'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} COV_FUNCTIONAL=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} DEBUG=1 COV_FUNCTIONAL=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} COV_FUNCTIONAL=1"
                build_command_line  = f"gmake -f {makefile} {build} DEBUG=1 COV_FUNCTIONAL=1"
        else:
            if (package == 'rx_pkg'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} COV_FUNCTIONAL=1 MSIM=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} COV_FUNCTIONAL=1 MSIM=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} COV_FUNCTIONAL=1 MSIM=1"
                build_command_line  = f"gmake -f {makefile} {build} COV_FUNCTIONAL=1 MSIM=1"
    else:
        if (simulator == 'vcs'):
            if (package == 'rx_pkg'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} DEBUG=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib}"
                build_command_line  = f"gmake -f {makefile} {build} DEBUG=1"
        else:
            if (package == 'rx_pkg'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} MSIM=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} MSIM=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} MSIM=1"
                build_command_line  = f"gmake -f {makefile} {build} MSIM=1"
...
def sim_process(index, test, test_dir_top, platform, coverage, simulator, package):
    makefile = "Makefile_" + simulator.upper() + '.mk'
    test_name_pattern = r'(\w+)\.svh'
    test_name_valid = re.search(test_name_pattern, test)
    ...
    if (test_name_valid):
        ...
        if (os.path.exists(test_file)):
            ...
            if (coverage == 'ral_cov'):
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg'):
                        sim_command_line = f"gmake -f {makefile} {testname} run DEBUG=1 COV=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run DEBUG=1 COV=1"
                else:
                    if(package == 'rx_pkg'):
                        sim_command_line = f"gmake -f {makefile} {testname} run DEBUG=1 COV=1 MSIM=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run DEBUG=1 COV=1 MSIM=1"                
            elif (coverage == 'fun_cov'):
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg'):
                        sim_command_line = f"gmake -f {makefile} {testname} run DEBUG=1 COV_FUNCTIONAL=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run DEBUG=1 COV_FUNCTIONAL=1"                    
                else:
                    if(package == 'rx_pkg'):
                        sim_command_line = f"gmake -f {makefile} {testname} run DEBUG=1 COV_FUNCTIONAL=1 MSIM=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run DEBUG=1 COV_FUNCTIONAL=1 MSIM=1"
            else:
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg'):
                        sim_command_line = f"gmake -f {makefile} {testname} run DEBUG=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run DEBUG=1"
                else:
                    if(package == 'rx_pkg'):
                        sim_command_line = f"gmake -f {makefile} {testname} run DEBUG=1 MSIM=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run DEBUG=1 MSIM=1"
...
def sim_farm_process(index, test, test_dir_top, platform, coverage, simulator, package):
    makefile = "Makefile_" + simulator.upper() + '.mk'
    ...
    if (test_name_valid):
        ...
        if (os.path.exists(test_file)):
            ...
            if (coverage == 'ral_cov'):
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run DEBUG=1 COV=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run DEBUG=1 COV=1"
                else:
                    if(package == 'rx_pkg'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run DEBUG=1 COV=1 MSIM=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run DEBUG=1 COV=1 MSIM=1"
            elif (coverage == 'fun_cov'):
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run DEBUG=1 COV_FUNCTIONAL=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run DEBUG=1 COV_FUNCTIONAL=1"
                else:
                    if(package == 'rx_pkg'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run DEBUG=1 COV_FUNCTIONAL=1 MSIM=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run DEBUG=1 COV_FUNCTIONAL=1 MSIM=1"
            else:
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run DEBUG=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run DEBUG=1"
                else:
                    if(package == 'rx_pkg'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run DEBUG=1 MSIM=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run DEBUG=1 MSIM=1"
...
if __name__ == "__main__":
    ...
    if not args.bypass_library_build:
        build_sim_env(args.platform, args.coverage, args.simulator, args.package)
    ...
    if args.run_regression_locally:
        ...
        test_items = [pool.apply_async(sim_process, (i, list_of_tests[i], test_dir, args.platform, args.coverage, args.simulator, args.package)) for i in range(total_processes_to_run)]
        ...
        test_items = [pool.apply_async(sim_farm_process, (i, list_of_tests[i], test_dir, args.platform, args.coverage, args.simulator, args.package)) for i in range(total_processes_to_run)]
