...
def set_top_list_of_tests(package):
    if (package == 'top_pkg'):
        top_list_of_tests = rootdir + "/verification/tests/test_top_pkg.svh"
    elif (package == 'test_pkg'):
        top_list_of_tests = rootdir + "/verification/tests/test_pkg.svh"
    elif (package == 'test_long_pkg'):
        top_list_of_tests = rootdir + "/verification/tests/test_long_pkg.svh"
    elif (package == 'rx_pkg'):
...
def set_make_dir():
    make_dir = rootdir + "/verification/scripts"
...
def build_sim_env(platform, coverage, simulator, package, tile):
    ...
    if (coverage == 'ral_cov'):
        if (simulator == 'vcs'):
            if (package == 'rx_pkg'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} COV=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} DEBUG=1 COV=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} COV=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} DEBUG=1 COV=1"
        else:
            if (package == 'rx_pkg'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} COV=1 MSIM=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} COV=1 MSIM=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} COV=1 MSIM=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} COV=1 MSIM=1"
    elif (coverage == 'fun_cov'):
        if (simulator == 'vcs'):
            if (package == 'rx_pkg'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} COV_FUNCTIONAL=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} DEBUG=1 COV_FUNCTIONAL=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} COV_FUNCTIONAL=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} DEBUG=1 COV_FUNCTIONAL=1"
        else:
            if (package == 'rx_pkg'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} COV_FUNCTIONAL=1 MSIM=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} COV_FUNCTIONAL=1 MSIM=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} COV_FUNCTIONAL=1 MSIM=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} COV_FUNCTIONAL=1 MSIM=1"
    else:
        if (simulator == 'vcs'):
            if (package == 'rx_pkg'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} DEBUG=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim}"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} DEBUG=1"
        else:
            if (package == 'rx_pkg'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} MSIM=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} MSIM=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} MSIM=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} MSIM=1"
...
def sim_process(index, test, test_dir_top, platform, coverage, simulator, package,tile):
    makefile = "Makefile_" + simulator.upper() + '.mk'
    test_name_pattern = r'(\w+)\.svh'
    test_name_valid = re.search(test_name_pattern, test)
    ...
    if (test_name_valid):
        ...
        if (os.path.exists(test_file)):
            ...
            if (coverage == 'ral_cov'):
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg'):
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV=1"
                else:
                    if(package == 'rx_pkg'):
                        sim_command_line = f"gmake -f {makefile} {testname} run  {tile_sim} DEBUG=1 COV=1 MSIM=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV=1 MSIM=1"                
            elif (coverage == 'fun_cov'):
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg'):
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV_FUNCTIONAL=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV_FUNCTIONAL=1"                    
                else:
                    if(package == 'rx_pkg'):
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV_FUNCTIONAL=1 MSIM=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV_FUNCTIONAL=1 MSIM=1"
            else:
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg'):
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} DEBUG=1"
                else:
                    if(package == 'rx_pkg'):
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 MSIM=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 MSIM=1"
...
def sim_farm_process(index, test, test_dir_top, platform, coverage, simulator, package, tile):
    makefile = "Makefile_" + simulator.upper() + '.mk'
    ...
    if (test_name_valid):
        ...
        if (os.path.exists(test_file)):
            ...
            if (coverage == 'ral_cov'):
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV=1"
                else:
                    if(package == 'rx_pkg'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV=1 MSIM=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV=1 MSIM=1"
            elif (coverage == 'fun_cov'):
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV_FUNCTIONAL=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV_FUNCTIONAL=1"
                else:
                    if(package == 'rx_pkg'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV_FUNCTIONAL=1 MSIM=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 COV_FUNCTIONAL=1 MSIM=1"
            else:
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} DEBUG=1"
                else:
                    if(package == 'rx_pkg'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 MSIM=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} DEBUG=1 MSIM=1"
            ...
            if (arc_submit_result == 0) and arc_submit_return_found:
                ...
                logger.info(f"   Farm process QUEUE_DATA: {queue}")
            else:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
            ...
            Example: below performs a UVM regression test, run locally, with 8 processes, for adp platform, using top_pkg set of tests, using VCS with no code coverage.
               python regress_run.py -l -n 8 -p adp -k top_pkg -s vcs -c none
            Same as above using long-form args: 
               python regress_run.py --local --n_procs 8 --plat adp --pack top_pkg --sim vcs --cov none
            Same as above, but run on Intel Farm (no --local): 
               python regress_run.py --plat adp --pack top_pkg --sim vcs --cov none
            Running script using defaults: run on Farm, adp platform, using top_pkg set of tests, using VCS with no code coverage:
    ...
    parser.add_argument('-k', '--pack', dest='package', type=str, nargs='?', default='top_pkg', choices=['top_pkg','test_pkg','test_long_pkg','hssi_tx_pkg','rx_pkg'], help='Test suite to run during regression.  (Default: %(default)s)')
    ...
    if not args.bypass_library_build:
        build_sim_env(args.platform, args.coverage, args.simulator, args.package, args.tile)
    ...
    if args.run_regression_locally:
        ...
        test_items = [pool.apply_async(sim_process, (i, list_of_tests[i], test_dir, args.platform, args.coverage, args.simulator, args.package, args.tile)) for i in range(total_processes_to_run)]
        ...
        test_items = [pool.apply_async(sim_farm_process, (i, list_of_tests[i], test_dir, args.platform, args.coverage, args.simulator, args.package, args.tile)) for i in range(total_processes_to_run)]
        ...
        for item in test_items:
            item.get()
            #found_item = item
            logger.info(f"FOUND_ITEM:")
        while not queue.empty():
            info_tuple = queue.get()
            test = info_tuple[0]
            info = info_tuple[1:]
            logger.info(f"INSIDE_Q_WHILE INFO_TUPLE : {info_tuple}")
