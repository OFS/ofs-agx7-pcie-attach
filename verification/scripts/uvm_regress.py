...
def set_top_list_of_tests(package):
    ...
    elif (package == 'rx_pkg_400G'):
        top_list_of_tests = rootdir + "/verification/tests/rx_pkg_400G.svh"
...
def build_sim_env(platform, coverage, simulator, package, tile, fims):
    ...
    if (coverage == 'ral_cov'):
        if (simulator == 'vcs'):
            if (package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} {fim} COV=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} {fim} DEBUG=1 COV=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} {fim} COV=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} {fim} DEBUG=1 COV=1"
        else:
            if (package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} {fim} COV=1 MSIM=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} {fim} COV=1 MSIM=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} {fim} COV=1 MSIM=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} {fim} COV=1 MSIM=1"
        ...
        if (simulator == 'vcs'):
            if (package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                ...
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} {fim} DEBUG=1 COV_FUNCTIONAL=1"
        else:
            if (package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} {fim} COV_FUNCTIONAL=1 MSIM=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} {fim} COV_FUNCTIONAL=1 MSIM=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} {fim} COV_FUNCTIONAL=1 MSIM=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} {fim} COV_FUNCTIONAL=1 MSIM=1"
    else:
        if (simulator == 'vcs'):
            if (package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} {fim} TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} {fim} DEBUG=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} {fim}"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} {fim} DEBUG=1"
        else:
            if (package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} {fim} MSIM=1 TEST_LPBK=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} {fim} MSIM=1 TEST_LPBK=1"
            else:
                cmplib_command_line = f"gmake -f {makefile} {cmplib} {tile_sim} {fim} MSIM=1"
                build_command_line  = f"gmake -f {makefile} {build} {tile_sim} {fim} MSIM=1"
...
def sim_process(index, test, test_dir_top, platform, coverage, simulator, package,tile, fims):
    makefile = "Makefile_" + simulator.upper() + '.mk'
    test_name_pattern = r'(\w+)\.svh'
    test_name_valid = re.search(test_name_pattern, test)
    ...
    if (test_name_valid):
        ...
        if (os.path.exists(test_file)):
            ...
            if (coverage == 'ral_cov'):
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV=1"
                else:
                    if(package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                        sim_command_line = f"gmake -f {makefile} {testname} run  {tile_sim} {fim} DEBUG=1 COV=1 MSIM=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} {fim}  DEBUG=1 COV=1 MSIM=1"                
            elif (coverage == 'fun_cov'):
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV_FUNCTIONAL=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV_FUNCTIONAL=1"                    
                else:
                    if(package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV_FUNCTIONAL=1 MSIM=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV_FUNCTIONAL=1 MSIM=1"
            else:
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1"
                else:
                    if(package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 MSIM=1 TEST_LPBK=1"
                    else:
                        sim_command_line = f"gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 MSIM=1"
...
def sim_farm_process(index, test, test_dir_top, platform, coverage, simulator, package, tile, fims):
    makefile = "Makefile_" + simulator.upper() + '.mk'
    ...
    if (test_name_valid):
        ...
        if (os.path.exists(test_file)):
            ...
            if (coverage == 'ral_cov'):
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV=1"
                else:
                    if(package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV=1 MSIM=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV=1 MSIM=1"
            elif (coverage == 'fun_cov'):
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV_FUNCTIONAL=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV_FUNCTIONAL=1"
                else:
                    if(package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV_FUNCTIONAL=1 MSIM=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 COV_FUNCTIONAL=1 MSIM=1"
            else:
                if (simulator == 'vcs'):
                    if(package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1"
                else:
                    if(package == 'rx_pkg' or package == 'rx_pkg_100G' or package == 'rx_pkg_400G'):
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 MSIM=1 TEST_LPBK=1"
                    else:
                        arc_submit_command_line = f"arc submit -PE flow/sw/bigmem mem=20000 -- gmake -f {makefile} {testname} run {tile_sim} {fim} DEBUG=1 MSIM=1"
...
if __name__ == "__main__":
    ...
    if args.run_regression_locally:
        ...
        test_items = [pool.apply_async(sim_process, (i, list_of_tests[i], test_dir, args.platform, args.coverage, args.simulator, args.package, args.tile, args.fims)) for i in range(total_processes_to_run)]
        ...
        test_items = [pool.apply_async(sim_farm_process, (i, list_of_tests[i], test_dir, args.platform, args.coverage, args.simulator, args.package, args.tile, args.fims)) for i in range(total_processes_to_run)]
