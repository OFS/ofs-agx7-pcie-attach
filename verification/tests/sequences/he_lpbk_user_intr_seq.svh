...
/**
 * Abstract:
 * class he_lpbk_user_intr_seq.svh is executed by he_lpbk_user_intr_test 
 * 
...
`ifndef HE_LPBK_USER_INTR_SEQ_SVH
`define HE_LPBK_USER_INTR_SEQ_SVH

class he_lpbk_user_intr_seq extends base_seq;
    `uvm_object_utils(he_lpbk_user_intr_seq)
    ...
    function new(string name = "he_lpbk_user_intr_seq");
        super.new(name);
    endfunction : new

    task body();
        super.body();
	`uvm_info(get_name(), "Entering he_lpbk_user_intr_seq ...", UVM_LOW)
	...
	`uvm_info(get_name(), "Exiting he_lpbk_user_intr_seq...", UVM_LOW)
    endtask : body

endclass : he_lpbk_user_intr_seq

`endif // HE_LPBK_USER_INTR_SEQ_SVH
