...
#
***Test Description***
This is the unit test for HE_HSSI/HSSI SS CSR access and HSSI traffic test

It covers the following test scenarios:
   * MMIO write 32-bit address and 64-bit address 
   * Simple ethernet traffic loopback test using HE_HSSI 
...
Description of test modules:
   ...
   * test_param_defs.sv - Defines test parameters for current test.
...
Note: HSSI SS take around 550us, this might take around 1hr of CPU time depending on system configuration
