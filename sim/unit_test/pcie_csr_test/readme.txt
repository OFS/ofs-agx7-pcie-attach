...
It covers the following test scenarios:
   * MMIO access 32-bit address and 64-bit address to PCIe CSR 
   * MMIO access 32-bit address and 64-bit address to unused PCIe CSR region

Description of test modules:
   * Details of top level testbench and PCIe BFM is documented in ../common/readme.txt
   * test_csr_defs.sv   - Defines PCIE CSR address ofset. 
