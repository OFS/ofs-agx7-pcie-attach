...
cp -rf $OFS_ROOTDIR/sim/unit_test/pmci_vdm_tx_rx_all_random_lpbk_test/cm_hier.file $OFS_ROOTDIR/sim/unit_test/pmci_vdm_tx_rx_all_random_lpbk_test/sim_vcs
