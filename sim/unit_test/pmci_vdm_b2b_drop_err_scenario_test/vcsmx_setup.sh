...
cp -rf $OFS_ROOTDIR/sim/unit_test/pmci_vdm_b2b_drop_err_scenario_test/cm_hier.file $OFS_ROOTDIR/sim/unit_test/pmci_vdm_b2b_drop_err_scenario_test/sim_vcsmx
