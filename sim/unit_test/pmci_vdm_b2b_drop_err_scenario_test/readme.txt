...
***Test Description***
This is the unit test for error testing of MCTP Back to back Drop scenario

It covers the following test scenarios:
   * RX payload will be sent back to back immediately to test this condition.
   * PMCI_SS requires some time to process the previous packets before sending this packet since this criteria is not met it will drop the present packet.
