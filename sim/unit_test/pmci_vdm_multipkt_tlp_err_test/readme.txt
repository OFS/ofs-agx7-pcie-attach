...
***Test Description***
This is the unit test for checking Error scnearios in multipacket MCTP VDM packets.

It covers the following test scenarios:
   * This test covers certain error scenarios for multipacket VDM messages 
   * Error scenarios include 
      *multipackets with different deid,seid,tag,pkt_sequence number etc
