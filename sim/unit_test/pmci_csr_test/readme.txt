...
***Test Description***
This is the unit test for PMCI CSR access

It covers the following test scenarios:
   * MMIO access 32-bit address and 64-bit address to PMCI CSR 
   * MMIO access 32-bit address and 64-bit address to unused PMCI CSR region
