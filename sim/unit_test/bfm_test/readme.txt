...
***Test Description***
This is the unit test for PCIe BFM. The test uses HE-LB to perform memory loopback between FIM and the host.

Description of test modules:
   * Details of top level testbench and PCIe BFM is documented in ../common/readme.txt
   * test_csr_defs.sv   - Defines HE-LB CSR addresses. 
