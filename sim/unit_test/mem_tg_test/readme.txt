...
***Test Description***
This is the unit test for HE-MEM Traffic generators. The test exercises MMIO access to the HE-MEM TG AFU at PF2 VF2 and
runs the traffic generators to test the memory interface.

Description of test modules:
   * Details of top level testbench and PCIe BFM is documented in ../common/readme.txt
   * test_csr_defs.sv   - Defines HE-MEM TG CSR addresses. 
