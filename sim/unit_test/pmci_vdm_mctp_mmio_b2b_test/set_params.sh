...
VCS_SIMV_PARAMS="$SIM_OPTIONS $USER_DEFINED_SIM_OPTIONS -cm tgl+line+cond+fsm+branch -cm_name $TEST_NAME -cm_test pmci -cm_dir ../../../regression.vdb -l transcript"

CM_OPTIONS="-cm tgl+line+cond+fsm+branch -cm_dir simv.vdb"