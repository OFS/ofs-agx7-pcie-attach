...
set_clock_groups -asynchronous -group {sys_pll|iopll_0_clk_sys} -group { pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|*|inst|inst|maib_and_tile|xcvr_hip_native|rx_ch15}
set_clock_groups -asynchronous -group {sys_pll|iopll_0_clk_100m } -group {pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|gen_ftile.u_ftile|intel_pcie_ftile_ast_qhip|rx_clkout|ch5}
set_clock_groups -asynchronous -group {pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|avmm_clock0} -group {pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|*|inst|inst|maib_and_tile|xcvr_hip_native|rx_ch15}
set_clock_groups -asynchronous -group {sys_pll|iopll_0_clk_100m} -group {pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|*|inst|inst|maib_and_tile|xcvr_hip_native|rx_ch15}
