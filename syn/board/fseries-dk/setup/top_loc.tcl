...
set_location_assignment PIN_BL55 -to qsfp_serial[0].rx_p[0]
set_location_assignment PIN_AW55 -to qsfp_serial[0].rx_p[1]
set_location_assignment PIN_BG55 -to qsfp_serial[0].rx_p[2]
set_location_assignment PIN_BC55 -to qsfp_serial[0].rx_p[3]

set_location_assignment PIN_BM54 -to qsfp_serial[0].rx_n[0]
set_location_assignment PIN_AY54 -to qsfp_serial[0].rx_n[1]
set_location_assignment PIN_BH54 -to qsfp_serial[0].rx_n[2]
set_location_assignment PIN_BD54 -to qsfp_serial[0].rx_n[3]

set_location_assignment PIN_AR55 -to qsfp_serial[1].rx_p[0]
set_location_assignment PIN_K52  -to qsfp_serial[1].rx_p[1]
set_location_assignment PIN_AL55 -to qsfp_serial[1].rx_p[2]
set_location_assignment PIN_P52  -to qsfp_serial[1].rx_p[3]

set_location_assignment PIN_AT54 -to qsfp_serial[1].rx_n[0]
set_location_assignment PIN_J51  -to qsfp_serial[1].rx_n[1]
set_location_assignment PIN_AM54 -to qsfp_serial[1].rx_n[2]
set_location_assignment PIN_N51  -to qsfp_serial[1].rx_n[3]

set_location_assignment PIN_AW49 -to qsfp_ref_clk
set_location_assignment PIN_AV48 -to "qsfp_ref_clk(n)"

set_location_assignment PIN_BL49 -to qsfp_serial[0].tx_p[0]
set_location_assignment PIN_BB52 -to qsfp_serial[0].tx_p[1]
set_location_assignment PIN_BK52 -to qsfp_serial[0].tx_p[2]
set_location_assignment PIN_BF52 -to qsfp_serial[0].tx_p[3]

set_location_assignment PIN_BM48 -to qsfp_serial[0].tx_n[0]
set_location_assignment PIN_BA51 -to qsfp_serial[0].tx_n[1]
set_location_assignment PIN_BJ51 -to qsfp_serial[0].tx_n[2]
set_location_assignment PIN_BE51 -to qsfp_serial[0].tx_n[3]

set_location_assignment PIN_AV52 -to qsfp_serial[1].tx_p[0]
set_location_assignment PIN_R49 -to qsfp_serial[1].tx_p[1]
set_location_assignment PIN_AP52 -to qsfp_serial[1].tx_p[2]
set_location_assignment PIN_V52 -to qsfp_serial[1].tx_p[3]

set_location_assignment PIN_AU51 -to qsfp_serial[1].tx_n[0]
set_location_assignment PIN_T48 -to qsfp_serial[1].tx_n[1]
set_location_assignment PIN_AN51 -to qsfp_serial[1].tx_n[2]
set_location_assignment PIN_U51 -to qsfp_serial[1].tx_n[3]
