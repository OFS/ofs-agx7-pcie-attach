...
set_location_assignment PIN_BF7  -to qsfp_serial[0].rx_p[0]
set_location_assignment PIN_BG10 -to qsfp_serial[0].rx_p[1]
set_location_assignment PIN_BK7  -to qsfp_serial[0].rx_p[2]
set_location_assignment PIN_BL10 -to qsfp_serial[0].rx_p[3]
set_location_assignment PIN_BP7  -to qsfp_serial[1].rx_p[0]
set_location_assignment PIN_BR10 -to qsfp_serial[1].rx_p[1]
set_location_assignment PIN_BV7  -to qsfp_serial[1].rx_p[2]
set_location_assignment PIN_BW10 -to qsfp_serial[1].rx_p[3]
...
set_location_assignment PIN_BF1 -to qsfp_serial[0].tx_p[0]
set_location_assignment PIN_BG4 -to qsfp_serial[0].tx_p[1]
set_location_assignment PIN_BK1 -to qsfp_serial[0].tx_p[2]
set_location_assignment PIN_BL4 -to qsfp_serial[0].tx_p[3]
set_location_assignment PIN_BP1 -to qsfp_serial[1].tx_p[0]
set_location_assignment PIN_BR4 -to qsfp_serial[1].tx_p[1]
set_location_assignment PIN_BV1 -to qsfp_serial[1].tx_p[2]
set_location_assignment PIN_BW4 -to qsfp_serial[1].tx_p[3]
