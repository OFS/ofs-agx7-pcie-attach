...
#    set_instance_assignment -name M20K_CE_CONTROL_FOR_PR ON -to afu_top|port_gasket|pr_slot|afu_main|pr_m20k_ce_ctl_req
    ...
    set_instance_assignment -name PLACE_REGION "X90 Y40 X295 Y165; X276 Y140 X344 Y212" -to afu_top|port_gasket|pr_slot|afu_main
