...
#**************************************************************
create_generated_clock -add -name pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|avmm_clock0 \
                       -source      [get_pins {pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|u_pciess_p0|gen_sub.u_hipif|u_pciess_clock_divider|clkdiv_inst|inclk}] \
                       -divide_by 2 [get_pins {pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|u_pciess_p0|gen_sub.u_hipif|u_pciess_clock_divider|clkdiv_inst|clock_div2}]
...
set_clock_groups -asynchronous -group {sys_pll|iopll_0_clk_sys} -group { pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|gen_ptile.u_ptile|intel_pcie_ptile_ast_qhip|inst|inst|maib_and_tile|xcvr_hip_native|rx_ch15}

set_clock_groups -asynchronous -group {pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|avmm_clock0} -group {pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|gen_ptile.u_ptile|intel_pcie_ptile_ast_qhip|inst|inst|maib_and_tile|xcvr_hip_native|rx_ch15}
set_clock_groups -asynchronous -group {sys_pll|iopll_0_clk_100m} -group {pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|gen_ptile.u_ptile|intel_pcie_ptile_ast_qhip|inst|inst|maib_and_tile|xcvr_hip_native|rx_ch15}
set_clock_groups -asynchronous -group {sys_pll|iopll_0_clk_100m} -group {pcie_wrapper|pcie_ss_top|pcie_ss|pcie_ss|avmm_clock0}
...
# removed in 23.2
set_false_path -from [get_keepers {afu_top|port_gasket|pr_ctrl|pr_m20k_ce_state[1]}] -to afu_top|port_gasket|pr_slot|afu_main*
